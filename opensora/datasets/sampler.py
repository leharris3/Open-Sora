...
class VariableNBAClipsBatchSampler(DistributedSampler):
    ...
    def group_by_bucket(self) -> dict[int, List[int]]:
        """
        ...
        bucket_sample_dict = {0: self.dataset.filtered_ds.filtered_clip_annotations_file_paths}
    ...
    def __iter__(self) -> Iterator[List[int]]:
        ...
        for i in range(start_iter_idx, num_iters):
            ...
            cur_micro_batch: List[MicroBatch] = [
                MicroBatch(idx, real_t, real_h, real_w) for idx in cur_micro_batch
            ]
